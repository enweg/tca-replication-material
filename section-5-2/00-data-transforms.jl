...
path_fred_quarterly = "./data/raw/Defense_quarterly.csv"
...
path_fred_annual = "./data/raw/Defense_annual.csv"
...
path_defense_owid = "./data/raw/military-expenditure-as-a-share-of-gdp-long.csv"
...
save("./plots/FRED-OWID-comparison.pdf", fig);
...
Legend(fig[2, :], ax; orientation = :horizontal, framevisible = false);
save("./plots/FRED-OWID-comparison-diff.pdf", fig);
...
save("./plots/FRED-OWID-comparison-quarterly.pdf", fig);
...
CSV.write("data/spending_quarter.csv", spending_quarter)

################################################################################
# Creating dataset for LP estimation
################################################################################

ramey2018 = DataFrame(CSV.File("./data/raw/RZDAT.csv"))
govdef = DataFrame(CSV.File("./data/spending_quarter.csv"))
...
CSV.write("./data/data_lp.csv", data_lp)
