...
if T_flag
    T = SW2007.static_g1_tt(T, y, x, params);
end
g1 = zeros(41, 41);
g1(1,11)=(-params(9));
g1(1,18)=(-(1-params(9)));
...
g1(22,31)=1-(T(10)+T(16)-T(17));
g1(22,39)=(-1);
g1(23,16)=(1-params(28))*params(27);
g1(23,27)=(-((1-params(28))*params(27)));
g1(23,29)=(-(params(25)*(1-params(28))));
g1(23,32)=1-params(28);
g1(23,37)=(-1);
g1(24,33)=1-params(29);
g1(25,34)=1-params(31);
g1(26,35)=1-params(32);
g1(27,36)=1-params(34);
g1(28,37)=1-params(35);
g1(29,9)=(-(1-params(8)));
g1(29,38)=1-params(36);
g1(30,9)=1;
g1(31,8)=(-(1-params(7)));
g1(31,39)=1-params(37);
g1(32,8)=1;
g1(33,26)=(-T(5));
g1(33,36)=(-(params(11)*T(5)*T(11)));
g1(33,41)=1-(1-T(5));
g1(34,29)=(-1);
g1(34,30)=1;
g1(35,4)=1;
